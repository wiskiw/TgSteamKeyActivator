...
exports.int2bigInt = int2bigInt;
exports.str2bigInt = str2bigInt;
exports.equalsInt = equalsInt;
exports.isZero = isZero;
exports.bigInt2str = bigInt2str;
exports.dup = dup;
exports.copy_ = copy_;
exports.copyInt_ = copyInt_;
exports.addInt_ = addInt_;
exports.rightShift_ = rightShift_;
exports.leftShift_ = leftShift_;
exports.sub_ = sub_;
exports.add_ = add_;
...
//globals
var bpe = exports.bpe = 0; //bits stored per array element
...
for (exports.bpe = bpe = 0; 1 << bpe + 1 > 1 << bpe; exports.bpe = bpe += 1, bpe - 1) {} //bpe=number of bits in the mantissa on this platform
exports.bpe = bpe >>= 1; //bpe=number of bits in one element of the array representing the bigInt
mask = (1 << bpe) - 1; //AND the mask with an integer to get its bpe least significant bits
radix = mask + 1; //2^bpe.  a single 1 bit to the left of the first bit of mask
var one = exports.one = int2bigInt(1, 1, 1); //constant used in powMod_()
...
//# sourceMappingURL=leemon.js.map