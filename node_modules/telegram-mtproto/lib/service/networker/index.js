...
class NetworkerThread {
  constructor({
    ...
    this.performSheduledRequest = () => {
      ...
      (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.DEL(pendingIds, this.dcID));
      ...
      (0, _core.dispatch)(_action.NET.SEND({
        message,
        options: {},
    ...
    (0, _core.dispatch)(_action.AUTH.SET_AUTH_KEY(authKey, this.dcID));
    ...
    (0, _core.dispatch)(_action.AUTH.SET_SERVER_SALT(serverSalt, this.dcID));
  ...
  updateSession() {
    ...
    (0, _core.dispatch)(_action.AUTH.SET_SESSION_ID(this.sessionID, this.dcID));
  }
  ...
  updateSentMessage(sentMessageID) {
    ...
    (0, _core.dispatch)(_action.NETWORKER_STATE.SENT.DEL([sentMessage], this.dcID));
    ...
    (0, _core.dispatch)(_action.NETWORKER_STATE.SENT.ADD(sentMessage, this.dcID));
    return sentMessage;
  }
  ...
  pushMessage(message, options = {}) {
    ...
    (0, _core.dispatch)(_action.NETWORKER_STATE.SENT.ADD(message, this.dcID));
    (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.ADD([message.msg_id], this.dcID));
  ...
  pushResend(messageID, delay = 0) {
    ...
    if (sentMessage instanceof _netMessage.NetContainer) {
      ...
      (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.ADD(sentMessage.inner, this.dcID));
    } else {
      (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.ADD([messageID], this.dcID));
  ...
  requestPerformer(message, noResponseMsgs, response) {
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        }(0, _core.dispatch)(_action.NETWORKER_STATE.SENT.DEL(sentDel, _this2.dcID));
        ...
        if (message instanceof _netMessage.NetContainer) {
          ...
          (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.ADD(message.inner, _this2.dcID));
          _this2.state.deleteSent(message);
        } else {
          (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.ADD([message.msg_id], _this2.dcID));
        ...
        }(0, _core.dispatch)(_action.NETWORKER_STATE.SENT.DEL(noRespSent, _this2.dcID));
        (0, _core.dispatch)(_action.NETWORKER_STATE.PENDING.DEL(noRespPending, _this2.dcID));
  ...
  applyServerSalt(newServerSalt) {
    ...
    return _asyncToGenerator(function* () {
      ...
      (0, _core.dispatch)(_action.AUTH.SET_SERVER_SALT(serverSalt, _this4.dcID));
  ...
  cleanupSent() {
    ...
    (0, _core.dispatch)(_action.NETWORKER_STATE.SENT.DEL(sentDel, this.dcID));
    return !notEmpty;
  }
        ...
        case 'msgs_state_info':
          {
            ...
            if (spliceCond) {
              ...
              (0, _core.dispatch)(_action.NETWORKER_STATE.RESEND.DEL(resendDel, _this5.dcID));
            }
            break;
          }
        case 'rpc_result':
          {
            ...
            (0, _core.dispatch)(_action.NETWORKER_STATE.SENT.DEL([_sentMessage2], _this5.dcID));
