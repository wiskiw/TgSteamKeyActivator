...
function Auth(uid, publisKeysHex, publicKeysParsed) {
  var mtpSendReqPQ = (() => {
    var _ref2 = _asyncToGenerator(function* (auth) {
      ...
      try {
        ...
        var [_p, _q, it] = yield _configProvider2.default.common.Crypto.factorize({ bytes: auth.pq });
  ...
  var mtpSendReqDhParams = (() => {
    var _ref3 = _asyncToGenerator(function* (auth) {
      ...
      var dataWithHash = (0, _bin.sha1BytesSync)(dataBox.getBuffer()).concat(hash);
  ...
  var mtpSendSetClientDhParams = (() => {
    var _ref4 = _asyncToGenerator(function* (auth) {
      ...
      var gB = yield _configProvider2.default.common.Crypto.modPow({
        x: gBytes,
        y: auth.b,
        m: auth.dhPrime
      });
      ...
      var authKey = yield _configProvider2.default.common.Crypto.modPow({
        x: auth.gA,
        y: auth.b,
        m: auth.dhPrime
      });
  ...
  var sendPlainReq = (0, _sendPlainReq2.default)(uid);
  var { prepare, select } = (0, _rsaKeysManger2.default)(uid, publisKeysHex, publicKeysParsed);
  ...
  function mtpDecryptServerDhDataAnswer(auth, encryptedAnswer) {
    ...
    var deserializer = new _tl.Deserialization(buffer, { mtproto: true }, uid);
    ...
    (0, _timeManager.applyServerTime)(uid, auth.serverTime, auth.localTime);
  }
  ...
  function mtpAuth(dcID, cached, dcUrl) {
    ...
    try {
      (0, _mtprotoShared.immediate)(authChain, auth);
    } catch (err) {
      return onFail(err);
    }
