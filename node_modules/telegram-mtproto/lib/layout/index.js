...
var hasEmpty = (0, _ramda.contains)('Empty');
var hasQuestion = (0, _ramda.contains)('?');
var hasVector = (0, _ramda.contains)('<');
var hasBare = (0, _ramda.contains)('%');
...
var isSimpleType = exports.isSimpleType = (0, _ramda.flip)(_ramda.contains)(['int', /*'long',*/'string', /*'double', */'true'] /*'bytes'*/);

var getFlagsRed = data => (acc, { name, flagIndex }) => (0, _ramda.has)(name, data) ? acc + Math.pow(2, flagIndex) : acc;
